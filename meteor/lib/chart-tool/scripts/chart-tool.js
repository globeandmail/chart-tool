/* Chart Tool v1.1.1-0 | https://github.com/globeandmail/chart-tool | MIT */
...
var dependencies = {"d3-array":"^1.0.1","d3-dispatch":"^1.0.1","d3-format":"^1.0.2","d3-scale":"^1.0.3","d3-selection":"^1.0.2","d3-shape":"^1.0.3"};
...
var require$$2$1 = ( env && env['default'] ) || env;
...
function getThumbnailPath(obj) {
  ...
  imgSettings.bucket = require$$2$1;
