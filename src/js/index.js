...
(function ChartToolInit(root) {
  ...
  var ChartTool = (function ChartTool() {
    ...
    // taken from https://github.com/viljamis/feature.js/
    var svgSupport = !!root.document && !!root.document.createElementNS && !!root.document.createElementNS("http://www.w3.org/2000/svg", "svg").createSVGRect;
    ...
    function createChart(container, obj) {
      ...
      if (svgSupport && root.d3) {
        ...
        // append chart images instead
        // NOTE: should rewrite clearChart to not be reliant on d3.
    ...
    function initializer(charts) {
      ...
      if (root.d3) {
        ...
        dispatcher = d3.dispatch("start", "finish", "redraw", "hoverIn", "hoverOut", "click");
    ...
    return {
      ...
      dispatch: function dispatch() {
        return d3.root ? d3.keys(dispatcher) : console.error("Chart Tool: no D3 library detected, unable to list dispatcher methods.");
      },
