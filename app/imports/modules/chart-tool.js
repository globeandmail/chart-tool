/* Chart Tool v1.4.2-0 | https://github.com/globeandmail/chart-tool | MIT */
(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('core-js/library/fn/object/assign'), require('core-js/fn/set'), require('core-js/fn/array/from')) :
    typeof define === 'function' && define.amd ? define(['core-js/library/fn/object/assign', 'core-js/fn/set', 'core-js/fn/array/from'], factory) :
    (global = global || self, global.ChartToolInit = factory());
    ...
    function stack() {
      ...
      stack.order = function(_) {
        return arguments.length ? (order = _ == null ? none$2 : typeof _ === "function" ? _ : constant$3(slice.call(_)), stack) : order;
      };
    ...
    function setTickFormatDate(selection, ctx, ems, monthsAbr) {
    ...
    function dropTicks(selection, opts) {
      ...
      for (var j = from; j < to; j++) {
        ...
        var c = selection._groups[0][j]; // current selection
        var n = selection._groups[0][j + 1]; // next selection
    ...
    function editableRange(annoEditable, obj) {
      ...
      var brush = (obj.annotationHandlers.rangeAxis === 'x' ? brushX : brushY)()
        .handleSize(3)
        .extent([
          [0, 0],
    ...
    function brushCentered(node, obj, brush) {
    ...
    var ChartManager = function ChartManager(container, obj) {
      ...
      if (this.recipe.options.annotations) {
        rendered.annotations = annotation(node, this.recipe);
      }
      ...
      if (this.recipe.CUSTOM) {
        rendered.custom = custom(node, this.recipe);
      }

    };

    var root$1 = typeof window !== 'undefined' ? window : undefined;
    ...
    var ChartTool = (function ChartTool() {
      ...
      function createLoop(resizeEvent) {
        if (root$1.ChartTool.length || resizeEvent) {
          var chartList = root$1.ChartTool.length ? root$1.ChartTool : charts;
          var loop = function ( i ) {
      ...
      function initializer() {
        ...
        dispatchFunctions = root$1.__charttooldispatcher || [];
        ...
        var debouncer = debounce$1(createLoop, true, chartSettings.debounce, root$1);
        ...
        if (root$1.ChartTool) { createLoop(); }
      }
    ...
    if (root$1) {
      ChartTool.init(root$1.ChartTool);
      root$1.ChartTool = ChartTool;
    }
