# In prod environment, we want to have Docker run the gulp lib-build command once
# to build production Chart Tool libs (maybe we can do the unminified version, though?).
# Once that's done, the rest of the build happens as normal
